...
function Precache( context )
	...
	--Cache the creature models
		...
		PrecacheResource( "soundfile", "soundevents/skullsound", context )

	--Preaching for spell particles i hope this fucking works
       	...
       	PrecacheResource( "particle", "particles/units/heroes/hero_enigma/enigma_base_attack_eidolon.vpcf", context )
      	...
      	PrecacheResource( "particle", "particles/units/heroes/hero_witchdoctor/witchdoctor_paralyzing_cask.vpcf", context )
      	PrecacheResource( "particle", "particles/units/heroes/hero_brewmaster/brewmaster_hurl_boulder.vpcf", context )


	--Preaching for sounds
    ...
    --Cache new particles
		...
		PrecacheResource( "particle", "particles/units/heroes/hero_alchemist/alchemist_unstable_concoction_projectile_explosion_flash_light.vpcf", context )
end
...
--	CustomNetTables:SetTableValue( "test", "value 2", { a = 1, b = 2 } );
	...
	elseif GetMapName() == "teams_10" then
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_GOODGUYS, 5 )
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_BADGUYS, 5 )
		self.m_GoldRadiusMin = 300
		self.m_GoldRadiusMax = 1400
		self.m_GoldDropPercent = 8
	elseif GetMapName() == "teams_20_lane" then
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_GOODGUYS, 10 )
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_BADGUYS, 10 )
		self.m_GoldRadiusMin = 300
		self.m_GoldRadiusMax = 1400
		self.m_GoldDropPercent = 8
	elseif GetMapName() == "teams_10_lane" then
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_GOODGUYS, 5 )
		GameRules:SetCustomGameTeamMaxPlayers( DOTA_TEAM_BADGUYS, 5 )
		self.m_GoldRadiusMin = 300
		self.m_GoldRadiusMax = 1400
		self.m_GoldDropPercent = 8
	elseif GetMapName() == "ffa_8_arena" then
